export default function VideoCardLarge({ image, title }) {
  return (
    <div className="md:flex items-center justify-center w-full md:w-1/2 h-60 md:h-90">
      <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl flex h-full m-4 relative w-full">
        ...
        <div className="absolute bottom-0 bg-black/50 w-full h-28">
          ...
          <a href="#" className="fill-white w-full h-auto">
            <svg
