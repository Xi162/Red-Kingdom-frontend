    ...
    return (
        <div className=''>
            <table className='border-separate border-spacing-0 min-w-full'>
                <thead>
                    <tr className=''>
                        <th className={`p-[10px] sticky top-0 bg-gray-300 text-left pl-5`}></th>
                        {headers.map((header, index) => (
                            <th key={index} className={`p-[10px] sticky top-0 bg-gray-300 text-left pl-5 ${index === 2 || index === 3 ? 'text-center pl-3' : ''
                                } text-[25px]`}>{header}</th>
                        ))}
                    </tr>
                </thead>
                                        ...
                                        <div>
                                            <div className='flex justify-evenly items-center mb-3'>
                                                <button className='border border-white rounded-[25px] bg-gray-300 p-1 hover:bg-gray-400'>
                                                    <svg className='w-6' fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            ...
                                            <div className='flex justify-center items-center'>
                                                <button className='border border-gray-300 pt-1 pb-1 pl-6 pr-6 shadow-inner hover:bg-gray-200'>
                                                    <svg className='w-8 text-primary' fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
